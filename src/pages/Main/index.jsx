...
const Main = () => {
  ...
  return (
    <div className="h-[calc(100vh-74px)] text-white bg-zinc-800 overflow-hidden flex flex-col justify-center items-center earth wrapper md:pt-20">
      <h1 className="px-6 pb-6">detay görüntüleri:{geo?.properties?.name}</h1>
      <ComposableMap
        height={1000}
